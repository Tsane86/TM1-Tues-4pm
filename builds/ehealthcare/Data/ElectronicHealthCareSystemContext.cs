...
{
    public partial class ElectronicHealthCareSystemContext : DbContext
    {
        public ElectronicHealthCareSystemContext()
        {
        }

        public ElectronicHealthCareSystemContext(DbContextOptions<ElectronicHealthCareSystemContext> options)
            : base(options)
        {
        }
